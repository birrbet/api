...
export class AppSettingRepository extends BaseRepository<AppSetting> {
  constructor(
    @InjectModel(AppSetting.name) private appSettingModel: Model<AppSetting>,
  ) {
...
export class TaxSettingRepository extends BaseRepository<TaxSetting> {
  constructor(
    @InjectModel(TaxSetting.name) private taxSettingModel: Model<TaxSetting>,
  ) {
...
export class SettingManager {
  ...
  taxSetting(): TaxSettingRepository {
    return this.taxSettingRepository;
  }
}
